"""
This scripts helps to create new project from beratung_erfurt files
"""
...
if __name__ == "__main__":
  args = sys.argv
  if len(args) != 2: print("\n\tUsage: ./beratung_erfurt.py <name_of_your_project>"); exit()
  ...
  rename(join(new_project_dir, "beratung_erfurt"), join(new_project_dir, new_project_name))
  replace_in_dir(new_project_dir, "beratung_erfurt", new_project_name)
